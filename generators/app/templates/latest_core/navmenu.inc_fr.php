	...
	public function getBackNextCode($page)
	{
		...
		if($previous == $page)
		{
			...
			}else
			{
				...
				return '<div class="stage_nav"><ul class="pager"><li class="previous unit"><a href="' . $this->linkPrefix . '?tab=' . ($this->tab - 1) . "&amp;page=" . $pageNum . "&amp;type=" . $this->type . $this->linkSuffix . '">&larr; Unité Précédente</a></li><li class="next"><a href="' . $this->linkPrefix . '?tab=' . $this->tab . '&amp;page=' . $next . "&amp;type=" . $this->type . $this->linkSuffix . '">Suivante &rarr;</a></li></ul></div>';								 
			}
		...
		}else if($next == $page)
		{
			...
			}else
			{
				...
				return '<div class="stage_nav"><ul class="pager"><li class="previous"><a href="' . $this->linkPrefix . '?tab=' . $this->tab  . '&amp;page=' . $previous . "&amp;type=" . $this->type . $this->linkSuffix . '">&larr; Précédente</a></li> <li class="next unit"><a href="' . $this->linkPrefix . '?tab=' . ($this->tab + 1) . '&amp;page=' . $pageNum . "&amp;type=" . $this->type . $this->linkSuffix . '">Unité Suivante &rarr;</a></li></ul></div>';								 
			}
