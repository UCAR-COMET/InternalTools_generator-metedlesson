...
// * Using JPSS CrIS Water Vapor and Air Mass RGB Products (10355)
// ********************************************************************* //
...
$(function () {
	...
	$('.radio .submit-button').click(function () {
		...
		// Trigger window resize to fix any image-sweep issues
	...
	$('.question-wrap-drag .done_drag').click(function () {
		...
		$(this).parents('.interaction-question').next('.show-after').show();
		// Trigger a window resize refresh to fix any issues
		$(window).resize();
	});
